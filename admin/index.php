    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
    	...
    	if($count > 0) {
            ...
            echo '<div class="container">
                ...
                <div  style="font-size:20px;" class="alert alert-danger text-center">انت لست مسؤل </div>   
...
<form class="login" action="<?php echo $_SERVER['PHP_SELF']; ?>" method='POST'>
	...
	<h3 style="font-size:30px;font-weight: bolder;" class="text-center">تسجيل الدخول المدير</h3>

	<input class= 'form-control' type="text" name="user" placeholder="الاسم المدير" autocomplete="off">

	<input class= 'form-control' type="password" name="pass" placeholder="كلمه المرور" autocomplete="new-password">

	<input class= 'btn btn-primary btn-block' type="submit" name="submit" value="تسجيل الدخول">
