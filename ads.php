        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if(empty($formerrors)) { // there is no errors
                ...
                $stmt1 = $con->prepare("INSERT INTO items (Name, Description, Price, Add_date, Country_made, Status, Cat_id, 
                    tags, Member_id) VALUES (:zname, :zdesc, :zprice, now(), :zcon, :zstat, :zcatid, :ztags, :zmemid)");
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-sm-10 col-md-9">
                                      <input type="text" name="name" class="form-control user-live" placeholder="write the Name of Item"  pattern=".{4, }" title="Must be 4 chars at Least " required=""/>    
                                    </div>
                            </div>
                            <!--end name-->
                            ...
                            <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-sm-10  col-md-9">
                                    <input type="text" name="descption" class="form-control desc" placeholder="Type your Description" maxlength="11"  title="Must be 10 chars at Least " required=""/>
